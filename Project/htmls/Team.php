...
<div class="col-12">
        ...
        <div class="container">
            <div class="row top-padding">
                ...
                <div class="col order centred">
                    <div class="round size-of-external-div">
                        <!--<img class="team-members-image-size round  hover-color size-on-hover rgba-blue-strong"  src=""/>-->
                        <div class="positioner">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="centred col-sm">
                    ...
                    <div class="fun-facts-description friendship top-padding"> 1460 days of friendship</div>
                </div>
                <div class="centred col-sm">
    ...
    <div class="">
        ...
        <div class="footer_top">
            <div class="container">
                ...
                <div class="col-md-3 footer_grid">
                    <h3>Contact Info</h3>
                    <ul class="address">
                        <li><i class="fa fa-map-marker" aria-hidden="true"></i>VIT <span>Chennai.</span></li>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:medicsteam2020@gmail.com">medicsteam2020@gmail.com</a></li>
                    <li><i class="fa fa-phone" aria-hidden="true"></i>+91 6381635536</li>
                    </ul>
                </div>
                <div class="col-md-3 footer_grid ">
        ...
        <div class="footer_copyrights">
            <p>© 2020 All rights reserved | <a href="#">Team Medics</a></p>
        </div>
    </div>
